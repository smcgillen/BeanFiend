class StoresController < ApplicationController
	def index
		if params[:query]
			local_stores=Gmaps4rails.places_for_address(params[:query].to_s, ENV["GOOG_API_KEY"], "coffee cafe -'Starbucks' -Dunkin -Donuts -Hagen -Daz -McDonalds -Pret -Quotedien -Barnes -Carrefour", 6000)
